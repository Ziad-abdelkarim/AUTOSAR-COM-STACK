      ...
      { { .CanControllerBaudRate = 200U,
        ...
        { .CanControllerBaudRate = 500U,
          ...
          .CanControllerDefaultBaudrate =
                  ...
                  .CanHardwareObject = { {
                                          .CanTriggerTransmitEnable = false, .CanHandleType =
                                                  FULL,
                                                  .CanObjectType = TRANSMIT, .CanControllerRef =
                                         ...
                                         { .CanTriggerTransmitEnable = false, .CanHwFilter =
                                         { .CanHwFilterMask = 0x0U,
                                           .CanHwFilterCode = 0x0U, },
                                           .CanHandleType = FULL, .CanObjectType = RECEIVE,
                                           .CanControllerRef =
                                                   &Can.CanConfigSet.CanController[0],
