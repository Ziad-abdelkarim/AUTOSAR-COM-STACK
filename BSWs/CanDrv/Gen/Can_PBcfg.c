		...
		{ 
			{
				...
				.CanControllerDefaultBaudrate = &Can.CanConfigSet.CanController[0U].CanControllerBaudrateConfig[0U]
			},
			...
			{ 
				...
				.CanControllerDefaultBaudrate = &Can.CanConfigSet.CanController[1U].CanControllerBaudrateConfig[0U]
			}
		},
